...
import { handleAddInvoices, handleGetAllInvoices,handleSearchInvoices,handleUpdateInvoice, handleGetInvoiceById, handleDownloadInvoicePDF } from '../controllers/invoice.controller.js'
...
invoiceRouter.get('/:id', verifyAdmin, handleGetInvoiceById)
invoiceRouter.get('/:id/pdf', verifyAdmin, handleDownloadInvoicePDF)
